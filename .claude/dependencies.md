...
| `@nuxt/ui` | ^4.6.1 | UIコンポーネントライブラリ |
| `tailwindcss` | ^4.2.2 | CSSフレームワーク |
| `pinia` | ^3.0.4 | 状態管理 |
| `@pinia/nuxt` | ^0.11.3 | Pinia Nuxt統合 |
| `@supabase/supabase-js` | ^2.103.3 | Supabase クライアント |
| `ai` | ^6.0.168 | Vercel AI SDK |
| `@ai-sdk/anthropic` | ^3.0.71 | Claude API接続 (AI SDK) |
| `@ai-sdk/vue` | ^3.0.168 | Vue統合 (useChat等) |
...
| `jspdf` | ^4.2.1 | PDF出力 |
| `marked` | ^18.0.1 | Markdown→HTML変換 |
| `dompurify` | ^3.4.0 | HTMLサニタイズ |

### devDependencies
| パッケージ | バージョン | 用途 |
|-----------|-----------|------|
| `@nuxt/devtools` | ^3.2.4 | 開発ツール |
| `@nuxt/eslint` | ^1.15.2 | ESLint統合 |
| `eslint` | ^10.2.0 | コード品質チェック |
| `typescript` | ^6.0.3 | 型チェック |
| `vitest` | ^4.1.4 | テストフレームワーク |
| `@nuxt/test-utils` | ^4.0.2 | Nuxtテストユーティリティ |
| `@vue/test-utils` | ^2.4.6 | Vueコンポーネントテスト |
| `happy-dom` | ^20.9.0 | テスト用DOM |
| `postgres` | ^3.4.9 | RLSテスト用DB接続 |
| `@vite-pwa/nuxt` | ^1.1.1 | PWA機能 |
| `@types/google.maps` | ^3.64.0 | Google Maps型定義 |
